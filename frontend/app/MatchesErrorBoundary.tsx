...
export class MatchesErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('[Matches]', error, errorInfo)
  }
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 max-w-md">
              We could not load your matches. Please check that the API server is running and try again.
            </p>
          </div>
          <Button
            variant="outline"
